$(function(){
	...
	username.complexify({minimumChars:5, strengthScaleFactor:0.0}, function(valid,complexity)
	{
	...
	pass1.complexify({minimumChars:8, strengthScaleFactor:0.3}, function(valid, complexity){
